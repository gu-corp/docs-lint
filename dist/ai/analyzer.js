...
export class RequirementAnalyzer {
     ...
     */
    async extractRequirements(specFiles) {
        ...
        for (const file of specFiles) {
            ...
            try {
                ...
                if (jsonMatch) {
                    const reqs = JSON.parse(jsonMatch[1]);
     ...
     */
    async checkTestCoverage(requirement, testFiles) {
    ...
    generateReport(coverages) {
        ...
        for (const cat of Object.keys(byCategory)) {
            byCategory[cat].percentage = Math.round((byCategory[cat].implemented / byCategory[cat].total) * 100);
        }
